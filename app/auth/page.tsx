  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 text-slate-50 flex items-center justify-center px-4 py-14">
      <div className="relative max-w-md w-full">
        <div className="absolute -top-16 left-8 h-36 w-36 rounded-full bg-sky-500/10 blur-3xl"></div>
        <div className="absolute -bottom-16 right-8 h-36 w-36 rounded-full bg-indigo-500/10 blur-3xl"></div>
        <div className="relative rounded-[2.5rem] border border-white/10 bg-slate-900/95 p-10 shadow-[0_35px_120px_-60px_rgba(0,0,0,0.8)] backdrop-blur-xl">
          <div className="text-center mb-8">
            <Link href="/" className="inline-block text-slate-400 hover:text-white text-sm mb-4">
              ← Back
            </Link>
            ...
            <p className="mx-auto mt-3 max-w-md text-sm text-slate-400 leading-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              ...
              className="w-full rounded-3xl bg-sky-400 py-4 text-sm font-semibold text-slate-950 transition hover:bg-sky-300 disabled:opacity-50 disabled:cursor-not-allowed"
            >
